package com.sevenspan.calarm.app.features.home.data.repository
...
interface HomeRepository {
     ...
     * @return Either a String error message on failure or a List of [com.sevenspan.calarm.app.core.model.CalendarEvent] on success.
     */
